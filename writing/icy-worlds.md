...
However, models indicate that even accounting for tidal heating due to its interaction with Saturn and its moon, Enceladus should not generate enough heat to maintain the liquid ocean that all chemical and gravitational analyses indicate must be there. The exact mechanism by which heat is created remains a mystery.
